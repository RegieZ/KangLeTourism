                                ...
                                <li class="addr-item">
                                    <div>
                                        ...
                                        <c:forEach items="${addressList}" var="address">
                                            <div class="con address"><input type="radio" name="addressId"
                                                                            value="${address.contact},${address.address},${address.telephone}"
                                                                            <c:if test="${address.isdefault==1}">checked="checked"</c:if>> ${address.contact}
                                                    ${address.address} <span>${address.telephone}</span></div>
                                        </c:forEach>
