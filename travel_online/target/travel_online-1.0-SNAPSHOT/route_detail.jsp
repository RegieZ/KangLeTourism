        ...
        <div class="prosum_right">
            ...
            <div class="pros_price">
                ...
                <div class="p_number">
                    ...
                    <span class="collect">
                        <!--a标签优先处理href，可以用javascript:void(0)或javascript:阻塞href属性-->
                    ...
                    <script>
                        $('#addCart').click(function () {
                            // 判断用户是否登录
                            if (${empty currentUser}) { // 未登录
                                // 触发登录按钮的点击事件
                                $('#loginBtn').click();
                            } else { // 已登录
                                // 获取用户
                                let num = $('#qty_item_1').val();
                                location.href = '${pageContext.request.contextPath}/CartServlet?action=addCart&rid=${route.rid}&num=' + num;
                            }
                        });
                    </script>
                </div>
