...
public class SmsUtils {
    ...
    // 需开发者指定
    private static String accessKeySecret = "pwd";
    ...
    public static void main(String[] args) throws Exception {
        /*// 模板（测试用）
        SendSmsResponse sendSmsResponse = sendSms("15853889888", "康乐旅游网", "SMS_190267873", "{\"code\":\"123456\"}");
        System.out.println(sendSmsResponse.getCode()); // 响应的状态码，代表本次发送短信的状态，如果没有输出ok而是输出了状态码即有错误，百度状态码即可
